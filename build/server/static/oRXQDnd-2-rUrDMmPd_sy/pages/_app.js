...
// CONCATENATED MODULE: ./components/_App/Header.js
...
function Header({
  ...
  return __jsx(external_semantic_ui_react_["Menu"], {
    stackable: true,
    fluid: true,
    id: "menu",
    inverted: true
  ...
  }), "Budget Buddy")), __jsx(link_default.a, {
    href: "/about"
  }, __jsx(external_semantic_ui_react_["Menu"].Item, {
    header: true,
    ...
    name: "cart",
    size: "large"
  }), "About")), isRootOrAdmin && __jsx(link_default.a, {
    href: "/create"
  }, __jsx(external_semantic_ui_react_["Menu"].Item, {
    header: true,
    ...
    name: "add square",
    size: "large"
  }), "Create")), user ? __jsx(external_react_default.a.Fragment, null, __jsx(link_default.a, {
    href: "/budget"
  }, __jsx(external_semantic_ui_react_["Menu"].Item, {
    header: true,
    ...
    name: "user",
    size: "large"
  }), "Transactions")), __jsx(external_semantic_ui_react_["Menu"].Item, {
    onClick: auth["b" /* handleLogout */],
    header: true
  }, __jsx(external_semantic_ui_react_["Icon"], {
    name: "sign out",
    size: "large"
  }), "Logout")) : __jsx(external_react_default.a.Fragment, null, __jsx(link_default.a, {
    href: "/login"
  }, __jsx(external_semantic_ui_react_["Menu"].Item, {
    header: true,
...
/* harmony default export */ var _App_Header = (Header);
// CONCATENATED MODULE: ./components/_App/HeadContent.js

var HeadContent_jsx = external_react_default.a.createElement;
/* harmony default export */ var HeadContent = (() => HeadContent_jsx(external_react_default.a.Fragment, null, HeadContent_jsx("meta", {
  name: "viewport",
  content: "width=device-width, initial-scale=1"
}), HeadContent_jsx("meta", {
  charSet: "utf-8"
}), HeadContent_jsx("link", {
...
function Layout({
  ...
  return Layout_jsx(external_react_default.a.Fragment, null, Layout_jsx(head_default.a, null, Layout_jsx(HeadContent, null), Layout_jsx("link", {
    rel: "stylesheet",
    type: "text/css",
  ...
  }), Layout_jsx("title", null, "ReactReserve")), Layout_jsx(_App_Header, {
    user: user
...
class _app_MyApp extends app_default.a {
  static async getInitialProps({
    ...
    if (!token) {
      ...
      if (isProtectedRoute) {
        Object(auth["c" /* redirectUser */])(ctx, "/login");
      }
    } else {
      try {
        const payload = {
        ...
        if (isNotPermitted) {
          Object(auth["c" /* redirectUser */])(ctx, "/");
        }
        ...
        Object(external_nookies_["destroyCookie"])(ctx, "token"); // 2) Redirect to login
  ...
  render() {
    ...
    return _app_jsx(_App_Layout, pageProps, _app_jsx(Component, pageProps));
  }
...
"use strict";
const baseUrl =  true ? "https://budget-buddy-296100.wm.r.appspot.com" : undefined;
