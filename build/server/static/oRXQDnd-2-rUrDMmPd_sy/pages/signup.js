...
/* harmony import */ var _utils_baseUrl__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("rjN7");
...
function Signup() {
  const [user, setUser] = react__WEBPACK_IMPORTED_MODULE_2___default.a.useState(INITIAL_USER);
  ...
  react__WEBPACK_IMPORTED_MODULE_2___default.a.useEffect(() => {
    const isUser = _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_1___default()(user).every(el => Boolean(el));
  ...
  function handleChange(event) {
    ...
    setUser(prevState => Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, prevState, {
      [name]: value
    }));
  }
  ...
  async function handleSubmit(event) {
    ...
    try {
      setLoading(true);
      setError("");
      const url = `${_utils_baseUrl__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"]}/api/signup`;

      const payload = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, user);

      const response = await axios__WEBPACK_IMPORTED_MODULE_5___default.a.post(url, payload);
      Object(_utils_auth__WEBPACK_IMPORTED_MODULE_8__[/* handleLogin */ "a"])(response.data);
    } catch (error) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Message"], {
    attached: true,
    icon: "settings",
    header: "Get Started!",
    ...
    header: "Oops!",
    content: error
  }), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Segment"], null, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Form"].Input, {
    fluid: true,
    icon: "user",
    iconPosition: "left",
    label: "Name",
    ...
    name: "help"
  }), "Existing user?", " ", __jsx(next_link__WEBPACK_IMPORTED_MODULE_4___default.a, {
    href: "/login"
