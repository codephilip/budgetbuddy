...
function Home({
  ...
  return pages_jsx(Index_ProductList, {
    products: products
  });
}

Home.getInitialProps = async () => {
  const url = `${baseUrl["a" /* default */]}/api/products`; // fetch data on server

  const response = await external_axios_default.a.get(url); // return response data as an object
