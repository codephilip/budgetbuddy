...
var _jsxFileName = "/Users/benguericke/OneDrive/BB/pages/login.js";
...
function Signup() {
  ...
  function handleChange(event) {
    ...
    setUser(prevState => Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, prevState, {
      [name]: value
    }));
  }
  ...
  async function handleSubmit(event) {
    ...
    try {
      setLoading(true);
      setError("");
      const url = `${_utils_baseUrl__WEBPACK_IMPORTED_MODULE_7__["default"]}/api/login`;

      const payload = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, user);

      const response = await axios__WEBPACK_IMPORTED_MODULE_5___default.a.post(url, payload);
      Object(_utils_auth__WEBPACK_IMPORTED_MODULE_8__["handleLogin"])(response.data);
    } catch (error) {
...
module.exports = __webpack_require__(/*! /Users/benguericke/OneDrive/BB/pages/login.js */"./pages/login.js");
