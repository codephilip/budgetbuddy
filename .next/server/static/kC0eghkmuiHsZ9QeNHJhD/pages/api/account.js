...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  try {
    const {
      userId
    } = jsonwebtoken__WEBPACK_IMPORTED_MODULE_1___default.a.verify(req.headers.authorization, "<insert-jwt-secret>");
    const user = await _models_User__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].findOne({
      _id: userId
    });
...
module.exports = __webpack_require__("09eZ");
